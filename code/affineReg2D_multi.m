function [ Iregistered, M] = affineReg2D_multi( para)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch ttype
    case 'r'
        ...
        for mr = para:-1:0
            ...
            [x]=fminunc(@(x)affine_function(x,scale,ISmoving1,ISfixed1,mtype,ttype),x,optimset('Display','iter','MaxIter',1000, 'TolFun', 1.000000e-06,'TolX',1.000000e-06, 'MaxFunEvals', 1000*length(x),'PlotFcn',@optimplotfval));
